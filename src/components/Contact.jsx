...
const Contact = () => {
  const contRef = useFadeUpOnScroll();
  return (
    <div>
      <div ref={contRef} className="me text-black fade-up">
        <h2 className="md:text-[1.5rem] py-3 px-5 border-3 border-black  mb-5 w-50 mx-auto mt-25 uppercase font-bold">
          Contact
        </h2>
        <p className="contact-text text-base md:w-150 w-full mx-auto mt-10  px-5 md:px-0 md:text-pretty text-balance">
